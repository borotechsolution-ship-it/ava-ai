...
import { PendingSubmitButton, PendingSubmitMessage } from "@/components/PendingSubmitButton";
    ...
    >
      ...
      <p>
        <PendingSubmitMessage
          idle="Tap once to call Ava. Your invite is consumed only when the call starts."
          pending="Starting Ava now. Please wait, do not tap again."
        />
      </p>
    </form>
  );
